...
Repository to generate fireplots every week for ECV. Click [here](https://TrevorWinstral.github.io/Fireplots) to get list of links to raw files, [here](https://TrevorWinstral.github.io/Fireplots/Uncompressed) for daily updated files. Click the link to jump to the image. \
